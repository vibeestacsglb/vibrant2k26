  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0,243,255,0.16) 1px, transparent 1px), linear-gradient(90deg, rgba(0,243,255,0.16) 1px, transparent 1px)",
      ...
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M 420 30 C 260 170, 340 330, 200 450 C 90 540, 210 640, 120 780" fill="none" stroke="rgba(255,0,60,0.5)" strokeWidth="1" />
        <path d="M 420 130 C 300 250, 370 390, 240 510" fill="none" stroke="rgba(255,0,60,0.3)" strokeWidth="0.7" />
        <path d="M 400 250 C 320 330, 360 420, 280 500" fill="none" stroke="rgba(255,0,60,0.2)" strokeWidth="0.6" />
      </svg>
      ...
      <div className="container-content relative z-10 text-center">
        ...
        <h1 className="relative opacity-0 animate-[fadeUp_0.9s_ease-out_0.2s_forwards] mx-auto w-fit mt-10 mb-16 md:mb-20">
          <span className="block font-marker text-poster-yellow text-[min(18vw,20vh)] leading-none drop-shadow-[0_0_15px_rgba(255,255,224,0.6)] -rotate-3 text-left">
            VIBRANT
          </span>
          <span className="absolute -bottom-6 right-0 font-display font-black italic text-poster-purple text-[min(14vw,14vh)] leading-none drop-shadow-[0_0_20px_#a855f7]">
            2K26
          </span>
        </h1>
