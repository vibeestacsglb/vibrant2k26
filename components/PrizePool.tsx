    ...
    <section className="py-28 md:py-40 text-center relative overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 md:gap-8">
          <Laurel className="w-10 md:w-14 h-auto hidden sm:block shrink-0" />
          <div className="gold-text font-display font-black text-[15vw] sm:text-6xl md:text-7xl leading-[0.92]">
            {siteConfig.prizePool}
          </div>
          <Laurel flip className="w-10 md:w-14 h-auto hidden sm:block shrink-0" />
        </div>

        <p className="mt-6 text-[13px] md:text-base font-semibold tracking-[0.24em] uppercase text-ink-300">
          {siteConfig.prizePoolSupport}
        </p>
        <p className="mt-6 max-w-md mx-auto text-[14.5px] text-ink-500">
