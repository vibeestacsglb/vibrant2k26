    ...
    <>
      ...
      >
        <div className="container-content flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link 
              href="/admin" 
              className="w-9 h-9 rounded-full bg-ink-900 border border-ink-800 flex items-center justify-center text-ink-400 hover:text-ink-0 hover:bg-ink-800 hover:border-vibeesta-500 transition-colors hidden sm:flex"
      ...
      >
        ...
        <Link
          href="/admin"
          onClick={() => setMenuOpen(false)}
          className="font-display font-bold text-2xl py-3 text-poster-cyan hover:text-ink-0 transition-colors"
        >
          Admin Login
        </Link>
        {registrationUrl ? (
